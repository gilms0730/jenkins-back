...
public class HouseController {
    ...
    public ResponseEntity findHouseByPriceDesc(
            @Valid @RequestBody GetHouseListPagingReq req
    ) {
    ...
    public ResponseEntity findHouseByName(
            @Valid @RequestBody GetHouseListPagingByNameReq req
    ) {
        return ResponseEntity.ok().body(houseService.findByName(req));
    }
    ...
    public ResponseEntity findHouseByAddress(
            @Valid @RequestBody GetHouseListPagingByAddrReq req
    ) {
        return ResponseEntity.ok().body(houseService.findByAddress(req));
    }
