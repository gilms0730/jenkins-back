...
public class HouseService {
    ...
    public List<GetFindHouseDtoRes> findByPriceDesc(GetHouseListPagingReq req){
    ...
    public List<GetFindHouseDtoRes> findByPriceAsc(GetHouseListPagingReq req){
        Pageable pageable = PageRequest.of(req.getPage()-1, req.getSize());
    ...
    public List<GetFindHouseDtoRes> findByName(GetHouseListPagingByNameReq req){
        Pageable pageable = PageRequest.of(req.getPage()-1, req.getSize());
        Page<House> result = houseRepository.findByName(pageable, req.getName());
    ...
    public List<GetFindHouseDtoRes> findByAddress(GetHouseListPagingByAddrReq req){
        Pageable pageable = PageRequest.of(req.getPage()-1, req.getSize());
        Page<House> result = houseRepository.findByAddress(pageable, req.getAddress());
